...
## P.S.
I will not create releases when I write new code, instead I publish to the main branch. If you wonder what a release does, please look in the [CHANGELOG](https://github.com/Loepker-James/enforce-rules/blob/main/CHANGELOG.md)
